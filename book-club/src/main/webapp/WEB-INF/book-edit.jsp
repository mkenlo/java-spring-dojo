...
<body>
    ...
    <div class="container bg-gray p-3">
        ...
        <div class="d-flex justify-content-between py-2  mb-3">
            <h4 class="text-primary-emphasis">Change Book Entry</h4>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <form:form action="/books/${book.id}/edit" method="put" modelAttribute="book">
                    ...
                    <div class="mb-3">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="book-author" name="author" value="${book.author}">
                    ...
                    <div class="mb-3">
                        <div class="form-floating">
                            <textarea id="review" name="review" class="form-control" style="height:150px">${book.review}</textarea>
                    ...
                    <div>
                        ...
                        <input type="hidden" value="${book.reviewer.id}" name="reviewer">
